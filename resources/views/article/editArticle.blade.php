...
<head>
    ...
    <title>Edit Article | Bipedia</title>
    {{-- Bootstrap CSS --}}
...
<body>
    ...
    <h2 class="text-center mt-2">Edit Article</h2>
        ...
        <div class="d-flex flex-column align-items-center pt-3 gap-3">
            <div class="form-group col-4">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror "
                    placeholder="Enter the title" name="title" value="{{ $article->title }}">
                @error('title')
            ...
            <div class="form-group col-4">
                <label>Content</label>
                <textarea class="form-control @error('content') is-invalid @enderror" name="content" rows="15" placeholder="Enter the content">{{ $article->content }}</textarea>
                @error('content')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
